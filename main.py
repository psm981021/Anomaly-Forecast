...
# python main.py --data_dir="data/radar_test" --image_csv_dir="data/22.7_22.9 강수량 평균 0.1 이하 제거_set추가.csv" --gpu_id=1 --batch=8 --use_multi_gpu --multi_devices=1,2,3 --device="cuda:1" --model_idx="test-projection"